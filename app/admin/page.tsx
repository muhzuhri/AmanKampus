...
export default function AdminDashboard() {
  ...
  return (
    <div className="min-h-screen bg-transparent text-stone-900 dark:text-stone-100 font-sans selection:bg-teal-500/20">
      ...
      {/* ── HEADER ─────────────────────────────────────────────────────── */}
      <header className="sticky top-0 z-40 bg-teal-950/95 dark:bg-stone-900/95 backdrop-blur-md border-b border-stone-800 dark:border-teal-900/50 shadow-md text-white">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-10 h-16 flex items-center justify-between gap-4 py-3">
          {/* Logo & Title */}
          <div className="flex items-center gap-3 shrink-0">
            <Link href="/" className="p-1.5 rounded-lg hover:bg-stone-800 dark:hover:bg-stone-800 transition-colors text-stone-300 hover:text-white">
            ...
            <div>
              ...
              <p className="text-[11px] text-teal-400 font-medium hidden md:block leading-tight">
                Portal Internal Verifikasi Laporan
              </p>
            </div>
          </div>

          {/* Navigation Tabs (Moved to top header) */}
          <div className="flex items-center gap-1 bg-stone-950/60 p-1 rounded-xl border border-stone-800">
            <button
              type="button"
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 py-6 space-y-5 relative z-10">
